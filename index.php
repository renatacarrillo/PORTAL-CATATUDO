...
<nav class="mt-5 mb-5">
    ...
    <div class="col-sm">
        ...
        <div class="col-sm fundo-cinza">
            ...
            <h3 class="corverde ml-3 mt-5">Você também pode ajudar a salvar o planeta, é só baixar o aplicativo nas lojas:</h3>
...
<section class="mb-5">
    ...
    <div class="col-sm-4 ml-5 mr-5 esp-caixas">
        <h1 class="sombreamento-text">CADASTRO</h1>
        <hr></hr>
        <h4 class="square-color">Você faz o cadastro no site e baixa o aplicativo nas lojas.</h4>
    </div>
    ...
    <div class="row efeito2">
    <div class="col-sm-4 ml-5 mr-5 esp-caixas">
        <h1 class="sombreamento-text">AGENDAMENTO</h1>
        <hr></hr>
        <h4 class="square-color">Você separa o lixo reciclável e pelo aplicativo agenda uma data para o coletor ir buscar.</h4>
    </div>
    ...
    <div class="col-sm-4 ml-5 mr-5 esp-caixas esp-caixas-b">
        <h1 class="sombreamento-text">PRONTO!</h1>
        <hr></hr>
        <h4 class="square-color">Você separa o lixo reciclável e aguarda um coletor ir fazer a retirada.</h4>
    </div>
...
<div class="container">
    <div class="row">
        ...
        <hr class="linha-cor-nav"></hr>
            <h3 class="square-color">Pessoas conscientes, como você, ajudam tanto o meio ambiente, como os coletores que são imprescindíveis nessa causa.</h3>
            <h2 class="text-center mt-4 sombreamento-text-nav">JUNTE-SE A NÓS!</h2>
            <hr class="linha-cor-nav"></hr>
        </div>

        <div class="col-sm">
        <img src="./IMAGENS/gerdau-2.png" class="efeito2 img-gerdau img-fluid" alt="Imagem fonte Gerdau">
        </div>
